...
const baseCategory = { id: 'cat-1', deleted_at: null, book_category_translations: [] };
...
describe('BookCategoriesService', () => {
      ...
      providers: [
        BookCategoriesService,
        {
          ...
          useValue: {
            ...
            book_category_translations: { upsert: jest.fn().mockResolvedValue({}) },
            books: { count: jest.fn() },
  ...
  describe('findAll', () => {
    it('filters translations by lang when Accept-Language is set', async () => {
      const category = { ...baseCategory, book_category_translations: [{ lang: 'ar', title: 'فقه', slug: 'fiqh' }] };
  ...
  describe('findOne', () => {
    it('returns category with lang-filtered translations', async () => {
      const category = { ...baseCategory, book_category_translations: [{ lang: 'en', title: 'Jurisprudence', slug: 'jurisprudence' }] };
